...
//
// Unlike the Prisma combos there is no client-generation step: Drizzle's schema *is* the
// TypeScript in `src/schema.ts`, so a composed variant is immediately typecheckable.
