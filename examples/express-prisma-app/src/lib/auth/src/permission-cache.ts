...
//      `createAuthApp`, without editing a line of this library. Keys are namespaced
 ...
 *
 * Used by each variant's authz middleware. The variants differ only in what a "subject" is — a user
