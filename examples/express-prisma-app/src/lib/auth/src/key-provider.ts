 ...
 *
 * Plain class, no DI container: Express has nothing like Nest's `@Injectable()`/`@Inject()`
 * machinery — just construct one of these yourself (see create-auth-app.ts) and pass it around.
 */
