...
export const AddUserPage = observer(function AddUserPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      toast.error(err instanceof AuthApiError ? err.message : "Couldn't create this user. Check the fields and try again.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">The new account becomes a member of {workspaceName}.</p>
      </div>
