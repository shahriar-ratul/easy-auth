...
export default function NewUserPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      toast.error(err instanceof AuthApiError ? err.message : "Couldn't create this user. Try again.");
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <div className="flex flex-col gap-4">
      <Card className="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            No invitation email — the account is usable immediately with the password set here, and becomes a member of {workspaceName}.
          </CardDescription>
        </CardHeader>
        <CardContent>
